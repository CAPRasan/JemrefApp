...
いきおい、Excelや手書きのメモに頼ることになりますが、文献の見落とし・見忘れ、記録の重複・紛失などのために、貴重な研究時間を無駄してしまいます。  

2. **文献管理の重要性は、これまでになく高まっている**  
研究のオリジナリティは、既存研究との対話から生まれます。  
しかし文献は年々増加し、質も多様化しています。そのフォローは容易ではありません。  
大学研究者の多忙化や、業績を求める圧力の高まりは、その問題をいっそう複雑にしています。  
膨大な文献を適切に評価・整理することは、文系研究が直面する現代的課題と考えます。  
